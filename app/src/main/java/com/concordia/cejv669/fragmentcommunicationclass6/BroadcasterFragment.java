...
public class BroadcasterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_broadcaster, container, false);
        Button b=v.findViewById(R.id.buttonSend);
        final EditText et=v.findViewById(R.id.editTextToSend);
